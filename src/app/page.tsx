        ...
        <section className="py-12 sm:py-16">
          ...
          <div className="grid gap-8 lg:grid-cols-5 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-2">
              <div className="aspect-[4/5] rounded-2xl bg-gradient-to-br from-teal-100 to-teal-50 flex items-center justify-center">
                <div className="text-center p-6">
                  <div className="mx-auto h-20 w-20 rounded-full bg-teal-200/60 flex items-center justify-center">
                    <svg className="h-10 w-10 text-[#0F766E]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                      <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />
                    </svg>
                  </div>
                  <p className="mt-3 text-sm text-teal-700 font-medium">Professional photo coming soon</p>
                </div>
              </div>
            </div>
          </div>
